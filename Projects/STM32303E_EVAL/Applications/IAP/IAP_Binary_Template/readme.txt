...
In order to load the SysTick example with the IAP, you must do the following:
 ...
 - TrueSTUDIO
    ...
    - Browse to the TrueSTUDIO workspace directory, select the project (.project file in \IAP_Binary_Template\TrueSTUDIO\STM32303E_EVAL directory).
    ...
    - A binary file "STM32303E_EVAL_SysTick.bin" will be generated under "/IAP_Binary_Template/TrueStudio/STM32303E_EVAL" folder. 
    - Finally load this image with IAP application
