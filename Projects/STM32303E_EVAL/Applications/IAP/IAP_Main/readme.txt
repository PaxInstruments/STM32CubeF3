...
In order to load the IAP code, you have do the following:
   ...
   - TrueSTUDO
      ...
      - Browse to the TrueSTUDIO workspace directory, select the project (.project file in \IAP_Main\TrueSTUDIO\STM32303E_EVAL directory).
   ...
   - SW4STM32
      ...
      - Browse to the STM workspace directory, select the project (.project file in \IAP_Main\SW4STM32\STM32303E_EVAL directory).
      - Rebuild all project files: Select the project in the "Project explorer" 
        window then click on Project->build project menu.
      - Run program.
